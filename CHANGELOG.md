...
### Day 17 — Ranking System

- Added `rankPatterns` step after scoring
- Ranked patterns by `score.finalScore`
- Added tie-break rules:
  - strength priority
  - pattern type priority
- Limited final output to top 2 ranked patterns
- Updated engine flow:
  - detectCorePatterns
